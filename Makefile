...
MODULES = cpu mult rob rs rrat rat prf free_list  fu cdb fu_cdb
...
# FU_CDB
FU_CDB_FILES = verilog/sys_defs.svh verilog/fu.sv verilog/cdb.sv verilog/mult.sv verilog/onehot_mux.sv
